...
#curl -H "Authorization: token ${5}" https://raw.githubusercontent.com/${4}/${3}/${2}/${1}
curl https://raw.githubusercontent.com/${4}/${3}/${2}/${1}?token=${5} --output $1
#fetch https://raw.githubusercontent.com/${4}/${3}/${2}/${1}?token=${5}
